...
python runners/train_finetuning_mdl.py --env_name=${game}-${level}-v2 --config=configs/${algo}_default.py --save_dir=${logdir} --id=${ID} --seed=${seed} ${test_args}
